...
static void SafariHandleDrawTrainerPic(void)
{
    DecompressTrainerBackPic(GetPlayerAvatarStyle(), gActiveBattler);
    SetMultiuseSpriteTemplateToTrainerBack(GetPlayerAvatarStyle(), GetBattlerPosition(gActiveBattler));
