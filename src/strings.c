...
const u8 gText_BirchInTrouble[] = _("Who do you choose?");
...
const u8 gText_HardLv50[] = _("HARD LV. 50");
const u8 gText_HardOpen[] = _("HARD OPEN");
const u8 gText_Regular[] = _("REGULAR");
...
const u8 gText_BigGuy[] = _("Big kid");
const u8 gText_BigGirl[] = _("Big kid");
const u8 gText_Son[] = _("child");
const u8 gText_Daughter[] = _("child");
...
const u8 gText_CheckPokemonInDetail[] = _("Create POKéMON and access PC.");
...
const u8 gText_Pokenav_AccessPC[] = _("Access your POKéMON storage.");
const u8 gText_Pokenav_OpenTeamLab[] = _("Build and manage battle teams.");
