...
struct BattleFrontier
{
    ...
    /*0xD09*/ u8 frontierChallengeMode;
    ...
    /*0xD1C*/ u16 domeTotalChampionships[2][FRONTIER_LVL_MODE_COUNT];
               u16 domeHardWinStreaks[2][FRONTIER_LVL_MODE_COUNT];
               u16 domeHardRecordWinStreaks[2][FRONTIER_LVL_MODE_COUNT];
               u16 domeHardTotalChampionships[2][FRONTIER_LVL_MODE_COUNT];
...
struct SaveBlock2
{
    ...
    /*0x08*/ u8 playerGender; // Legacy compatibility field; always FEMALE for the player
...
struct SaveBlock1
{
    ...
    /*0x3598*/ struct
    {
        u32 towerWinStreakActiveFlags;
        u16 towerWinStreaks[2][FRONTIER_LVL_MODE_COUNT];
        u16 towerRecordWinStreaks[2][FRONTIER_LVL_MODE_COUNT];
        u32 palaceWinStreakActiveFlags;
        u16 palaceWinStreaks[2][FRONTIER_LVL_MODE_COUNT];
        u16 palaceRecordWinStreaks[2][FRONTIER_LVL_MODE_COUNT];
        u32 arenaWinStreakActiveFlags;
        u16 arenaWinStreaks[FRONTIER_LVL_MODE_COUNT];
        u16 arenaRecordWinStreaks[FRONTIER_LVL_MODE_COUNT];
        u32 factoryWinStreakActiveFlags;
