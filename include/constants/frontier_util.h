...
#define FRONTIER_DATA_CHALLENGE_MODE     8

#define FRONTIER_CHALLENGE_NORMAL 0
#define FRONTIER_CHALLENGE_HARD   1
...
#define STREAK_DOME_HARD_SINGLES_50   (1 << 26)
#define STREAK_DOME_HARD_SINGLES_OPEN (1 << 27)
#define STREAK_DOME_HARD_DOUBLES_50   (1 << 28)
#define STREAK_DOME_HARD_DOUBLES_OPEN (1 << 29)
